...
model.i = Set(initialize=['P1'], doc='indice des noeuds producteurs')
model.j = Set(initialize=['C1','C2'], doc='indice des noeuds consommateurs')
model.o = Set(initialize=['C1','C2'], doc='indice des noeuds consommateurs')
model.k = Set(initialize=['k1'], doc='indice technologie de production')
...
model.C_tr_unit = Param(initialize=800, doc='coût unitaire de tranchee aller-retour (€/ml)')
model.period = Param(initialize=5808, doc='durée de fonctionnement annuelle du RCU (h)')
model.annee = Param(initialize=15, doc='duree d\'amortissement (année)')
model.x_P = Param(model.i, initialize={'P1':0}, doc='abscisse d\'un noeud producteur (m)')
model.z_P = Param(model.i, initialize={'P1':0}, doc='ordonnée d\'un noeud producteur (m)')
model.C_Hprod_unit = Param(model.k,initialize={'k1':800}, doc='coût unitaire  de la chaudiere installée (€/kW)')
model.C_heat_unit = Param(model.k,initialize={'k1':0.08}, doc='coût unitaire de la chaleur suivant l\'énergie de la technologie employee et la periode selon inflation (€/kWh)')
model.Eff = Param(model.k,initialize={'k1':0.9}, doc='rendement de la technologie k (%)')
model.rate_i = Param(model.k,initialize={'k1':0.04}, doc='inflation de l\'énergie liée à la technologie k (%)')
model.rate_i_pump = Param(initialize=0.04, doc='inflation du coût de l\'électricite pour le pompage (%)')
model.x_C = Param(model.j, initialize={'C1':60,'C2':0}, doc='abscisse d\'un noeud consommateur (m)')
model.z_C = Param(model.j, initialize={'C1':40,'C2':40}, doc='ordonnée d\'un noeud consommateur (m)')
model.H_req = Param(model.j, initialize={'C1':80,'C2':80}, doc='besoin de chaleur (kW)')
model.T_req_out = Param(model.j, initialize={'C1':60,'C2':60}, doc='température entree reseau secondaire du consommateur (°C)')
model.T_req_in = Param(model.j, initialize={'C1':80,'C2':80}, doc='température retour reseau secondaire du consommateur (°C)')
...
model.Y_P = Param(model.i, model.k, initialize=table_Y_P, doc='Existence techno k au lieu de production Pi')
...
model.Y_linePC = Param(model.i, model.j, initialize=table_Y_linePC, doc='Existence canalisation PC')
...
model.Y_lineCP = Param(model.j, model.i, initialize=table_Y_lineCP, doc='Existence canalisation CP')
...
model.Y_lineCC_parallel = Param(model.j, model.o, initialize=table_Y_lineCC_parallel, doc='Existence canalisation CC parallel')
...
model.Y_lineCC_return = Param(model.o, model.j, initialize=table_Y_lineCC_return, doc='Existence canalisation CC return')


# Définition des paramètres ne dépendant pas de la taille du problème
## Valeur affectée
model.Eff_pump = Param(initialize=0.7, doc='rendement de la pompe pour le calcul du coût de pompage(%)')
model.T_hx_pinch = Param(initialize=5, doc='température de pincement minimum a l\'échangeur (°C)')
model.K_hx = Param(initialize=20, doc='coefficient global d\'échange (kW/m2.K)')
model.Cp = Param(initialize=4.196, doc='capacite thermique de l\'eau à 80°C (kJ/kg.K)')
model.C_pump_unit = Param(initialize=0.11, doc='coût unitaire de l\'électricite pour le pompage (€/kWh)')
model.mu = Param(initialize=0.000354, doc='viscosite de l\'eau a 80°C (Pa.s)')
model.rho = Param(initialize=974, doc='masse volumique de l\'eau a 20°C (kg/m3)')
model.alpha = Param(initialize=1.75, doc='exposant pour le calcul des pertes de charge et le calcul du coût de pompage')
model.beta = Param(initialize=-1.25, doc='exposant pour le calcul des pertes de charge et le calcul du coût de pompage')
model.C_pipe_unit_a = Param(initialize=0.3722, doc='coefficient directeur de la relation linéaire du coût de la canalisation selon le diamètre (ensemble tuyau+isolant)(€/m)')
model.C_pipe_unit_b = Param(initialize=12.48, doc='ordonnée à l\'origine de la relation linéaire du coût de la canalisationselon le diamètre (ensemble tuyau+isolant)(€)')
model.C_hx_unit_a = Param(initialize=5.3, doc='coefficient directeur du coût unitaire de l\'echangeur (€/kW )')
model.C_hx_unit_b = Param(initialize=5045, doc='ordonnee à l\'origine du coût unitaire de l\'echangeur (€)')
model.rate_a = Param(initialize=0.04, doc='taux d\'actualisation pour le calcul de l\'annuite des investissements initiaux')
model.T_ext = Param(initialize=15, doc='température extérieure pour le calcul des pertes thermiques de la canalisation')
model.lambda_insul = Param(initialize=0.03, doc='conductivite thermique de l\'isolant (W/m.K)')
model.lambda_soil = Param(initialize=1.4, doc='conductivite thermique du sol (W/m.K)')
model.z_pipe = Param(initialize=0.4, doc='hauteur de sol au dessus des canalisations pour le calcul des pertes thermiques (m)')
model.epsilon = Param(initialize=0.000000001, doc='chiffre infinitesimal utile pour éviter les erreurs de division par zero')
model.tk_insul = Param(initialize=0.0276, doc='épaisseur de l\'isolant autour de la canalisation (m)')
model.tk_pipe = Param(initialize=0.025, doc='épaisseur de metal dependant du diametre (m)')
model.DP_hx_unit = Param(initialize=20, doc='perte de charge dans un echangeur (kPa)')

## bornes
model.V_min = Param(initialize=0.1, doc='borne vitesse min, 0.1m/s d\'après Techniques de l\'Ingénieur (m/s)')
model.V_max = Param(initialize=3, doc='borne vitesse max, 3m/s d\'après Techniques de l\'Ingénieur (m/s)')
model.P_min = Param(initialize=120, doc='pression minimale en borne inférieure (kPa)')
model.P_max = Param(initialize=500, doc='pression max en borne supérieure (kPa)')
model.T_prod_out_max = Param(model.k,initialize={'k1':100}, doc='température max autorisée en sortie de chaudiere de la techno k (°C)')
model.T_prod_in_min = Param(model.k,initialize={'k1':30}, doc='température min autorisée en entree de chaudiere de la techno k (°C)')
model.Dint_max = Param(initialize=0.25, doc='diamètre interieur max du tuyau (m)')
model.Dint_min = Param(initialize=0.01, doc='diamètre interieur max du tuyau (m)')
model.Dist_max_autorisee = Param(initialize=1000, doc='distance max pour borner les longueurs de canalisations (m)')
...
model.H_inst_max = Param(initialize=calcul_H_inst_max)
...
model.H_inst_bigM = Param(initialize=calcul_H_inst_bigM)
...
model.gamma = Param(initialize=calcul_gamma)
...
model.Dist_PC = Param(model.i,model.j,initialize=calcul_DistPC)
...
def calcul_DistCC(model,j,o):
    ...
    if j != o:
        ...
        return 0
model.Dist_CC = Param(model.j,model.o,initialize=calcul_DistCC)

model.Dist_bigM = Param(initialize=model.Dist_max_autorisee)
...
model.f_opex = Param(model.k,initialize=calcul_f_opex)
...
model.f_opex_pump = Param(initialize=calcul_f_opex_pump)
...
model.f_capex = Param(initialize=calcul_f_capex)
...
model.M_max = Param(initialize=calcul_M_max)

model.M_min = Param(initialize=0, doc='débit minimal dans la canalisation')

def calcul_M_bigM(model):
    """BigM associé au débit maximal pour l'optimisation des débits"""
    return 1000*model.M_max
model.M_bigM = Param(initialize=calcul_M_bigM)
...
model.T_init_min = Param(initialize=calcul_T_init_min)
...
model.T_init_max = Param(initialize=calcul_T_init_max)
...
model.L_PC = Param(model.i, model.j, initialize=table_L_PC, doc='matrice des longueurs de canalisations')
...
model.L_CP = Param(model.j, model.i, initialize=table_L_CP, doc='matrice des longueurs de canalisations')
...
model.L_CC_parallel = Param(model.j, model.o, initialize=table_L_CC_parallel, doc='matrice des longueurs de canalisations')
...
model.L_CC_return = Param(model.o, model.j, initialize=table_L_CC_return, doc='matrice des longueurs de canalisations')
...
## vitesses
model.V_linePC = Var(model.i, model.j,initialize=(model.V_min+model.V_max)/2,bounds=(0,model.V_max), doc='vitesses conduites producteurs-consommateurs = ALLER')
model.V_lineCP = Var(model.j, model.i,initialize=(model.V_min+model.V_max)/2,bounds=(0,model.V_max), doc='vitesses conduites consommateurs-producteurs = RETOUR')
model.V_lineCC_parallel = Var(model.j, model.o,initialize=(model.V_min+model.V_max)/2,bounds=(0,model.V_max), doc='vitesses conduites consommateurs-consommateurs ALLER')
model.V_lineCC_return = Var(model.o, model.j,initialize=(model.V_min+model.V_max)/2,bounds=(0,model.V_max), doc='vitesses conduites consommateurs-consommateurs RETOUR')

## Diamètres
model.Dint_PC = Var(model.i, model.j,initialize=(model.Dint_min+model.Dint_max)/2,bounds=(model.Dint_min,model.Dint_max), doc='diamètres intérieurs conduites producteurs-consommateurs = ALLER')
model.Dint_CP = Var(model.j, model.i,initialize=(model.Dint_min+model.Dint_max)/2,bounds=(model.Dint_min,model.Dint_max), doc='diamètres intérieurs conduites consommateurs-producteurs = RETOUR')
model.Dint_CC_parallel = Var(model.j, model.o,initialize=(model.Dint_min+model.Dint_max)/2,bounds=(model.Dint_min,model.Dint_max), doc='diamètres intérieurs conduites consommateurs-consommateurs ALLER')
model.Dint_CC_return = Var(model.o, model.j,initialize=(model.Dint_min+model.Dint_max)/2,bounds=(model.Dint_min,model.Dint_max), doc='diamètres intérieurs conduites consommateurs-consommateurs RETOUR')
model.Dout_PC = Var(model.i, model.j,initialize=(model.Dint_min+model.Dint_max)/2,bounds=(model.Dint_min,model.Dint_max), doc='diamètres extérieurs conduites producteurs-consommateurs = ALLER')
model.Dout_CP = Var(model.j, model.i,initialize=(model.Dint_min+model.Dint_max)/2,bounds=(model.Dint_min,model.Dint_max), doc='diamètres extérieurs conduites consommateurs-producteurs = RETOUR')
model.Dout_CC_parallel = Var(model.j, model.o,initialize=(model.Dint_min+model.Dint_max)/2,bounds=(model.Dint_min,model.Dint_max), doc='diamètres extérieurs conduites consommateurs-consommateurs ALLER')
model.Dout_CC_return = Var(model.o, model.j,initialize=(model.Dint_min+model.Dint_max)/2,bounds=(model.Dint_min,model.Dint_max), doc='diamètres extérieurs conduites consommateurs-consommateurs RETOUR')

## Débits
model.M_linePC = Var(model.i,model.j,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit entre un noeud P(i) et C(j) (kg/s)')
model.M_lineCP = Var(model.j,model.i,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit entre un noeud C(j) et P(i) (kg/s)')
model.M_prod = Var(model.i,model.k,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit de la techno k(k) dans P(i) (kg/s)')
model.M_prod_tot = Var(model.i,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit dans P(i) = somme des débits des technos k(k) (kg/s)')
model.M_hx = Var(model.j,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit dans l\'échangeur de C(j) côté primaire (kg/s)')
model.M_supply = Var(model.j,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit avant l\'échangeur de C(j); différent de M_hx seulement si cascade autorisée (kg/s)')
model.M_lineCC_parallel = Var(model.j,model.o,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit entre un noeud C(j) et C(o) - ALLER (kg/s)')
model.M_lineCC_return = Var(model.o,model.j,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit entre un noeud C(o) et C(j) - RETOUR (kg/s)')
model.M_return = Var(model.j,initialize=model.M_min,bounds=(model.M_min,model.M_max), doc='debit après l\'échangeur au noeud C(j); différent de M_hx seulement si cascade (kg/s)')

## Températures
model.T_prod_in = Var(model.i,model.k,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de sortie de la technologie k à la production i (°C)')
model.T_prod_tot_in = Var(model.i,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de sortie de la production i = mélange des k technologies (°C)')
model.T_prod_out = Var(model.i,model.k,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de retour de la technologie k à la production i = température de retour à la production i (°C)')
model.T_prod_tot_out = Var(model.i,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de retour à la production i (°C)')
model.T_linePC_in = Var(model.i, model.j,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de départ de la production i (°C)')
model.T_linePC_out = Var(model.i, model.j,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température d\'entrée dans le premier noeud = température de départ de la production i - pertes (°C)')
model.T_lineCP_in = Var(model.j, model.i,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de départ du dernier noeud (°C)')
model.T_lineCP_out = Var(model.j, model.i,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de retour à la production i = température de départ du dernier noeud - pertes (°C)')
model.T_hx_in = Var(model.j,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température d\'entrée dans l\'échangeur (°C)')
model.T_hx_out = Var(model.j,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de sortie de l\'échangeur (°C)')
model.T_supply = Var(model.j,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température avant l\'échangeur de C(j) = T_hx_in (°C)')
model.T_lineCC_parallel_in = Var(model.j, model.o,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de départ au noeud C(j) - ALLER (°C)')
model.T_lineCC_parallel_out = Var(model.j, model.o,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température d\'arrivée au noeud C(o) - ALLER (°C)')
model.T_lineCC_return_in = Var(model.o, model.j,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température de départ au noeud C(o) - RETOUR (°C)')
model.T_lineCC_return_out = Var(model.o, model.j,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température d\'arrivée au noeud C(j) - RETOUR (°C)')
model.T_return = Var(model.j,initialize=model.T_init_min,bounds=(model.T_init_min,model.T_init_max), doc='température après l\'échangeur de C(j) = T_hx_out (°C)')

## Echangeur
model.DTLM = Var(model.j,initialize=max(model.T_prod_out_max[k] for k in model.k), bounds=(0,max(model.T_prod_out_max[k] for k in model.k)), doc='Différence logarithmique de température à l’échangeur de chaleur (°C)')
model.DT1 = Var(model.j,initialize=model.T_hx_pinch, bounds=(model.T_hx_pinch,model.T_init_max), doc='Différence de température côté chaud = T_hx_in - T_req_out (°C)')
model.DT2 = Var(model.j,initialize=model.T_hx_pinch, bounds=(model.T_hx_pinch,model.T_init_max), doc='Différence de température côté froid = T_hx_out - T_req_in (°C)')
...
model.A_hx = Var(model.j,initialize=A_hx_init,bounds=A_hx_borne, doc='surface de l\'échangeur pour chaque consommateur j, bornée par le pincement T_hx_pinch ==> cf calcul de A_hx_borne')

## Pressions pour le coût_pompage
model.P_pump = Var(model.i,initialize=0,bounds=(0,model.P_max), doc='Pressions de pompage (Pa)')

## Puissances installées
model.H_inst = Var(model.i,model.k,initialize=0,bounds=(0,model.H_inst_max), doc='Puissance installée à la production i pour la technologie k (kW)')
# model.H_hx = Var(model.j,bounds=(0,80,), doc='Puissance nominale de l\'échangeur du consommateur j')

def H_hx_borne(model,j):
    return (0,model.H_req[j])
model.H_hx = Var(model.j,initialize=0,bounds=H_hx_borne, doc='Puissance nominale de l\'échangeur du consommateur j')

## Coûts
model.C_pump = Var(initialize=0,bounds=(0,None), doc='Coûts de pompage (€)')
model.C_heat = Var(initialize=0,bounds=(0,None), doc='Coût de la chaleur à produire (€)')
model.C_Hinst = Var(initialize=0,bounds=(0,None), doc='Coût d\'installation de la puissance à la production (€)')
model.C_hx = Var(initialize=0,bounds=(0,None), doc='Coût d\'installation des échangeurs en sous-station (€)')
model.C_line_tot = Var(initialize=0,bounds=(0,None), doc='Coût total de la canalisation = tranchée + tuyau pré-isolé (€) ')
model.C_pipe = Var(initialize=0,bounds=(0,None), doc='Coût des tuyau pré-isolés (€)')
model.C_tr = Var(initialize=0,bounds=(0,None), doc='Coût de tranchée (€)')

## Longueur du réseau
model.L_tot = Var(initialize=0,bounds=(0,None), doc='Longueur totale du réseau = longueur de tuyaux posés = 2 fois la longueur de tranchée car tuyau aller-retour')
...
model.Def_Dout_PC = Constraint(model.i,model.j,rule=Def_Dout_PC_rule)
...
model.Def_Dout_CP = Constraint(model.j,model.i,rule=Def_Dout_CP_rule)
...
model.Def_Dout_CC_parallel = Constraint(model.j,model.o,rule=Def_Dout_CC_parallel_rule)
...
model.Def_Dout_CC_return = Constraint(model.o,model.j,rule=Def_Dout_CC_return_rule)
...
model.Def_V_linePC_bigM = Constraint(model.i,model.j,rule=Def_V_linePC_rule_bigM)
...
model.Def_V_lineCP_bigM = Constraint(model.j,model.i,rule=Def_V_lineCP_rule_bigM)
...
model.Def_V_lineCC_parallel_bigM = Constraint(model.j,model.o,rule=Def_V_lineCC_parallel_rule_bigM)
...
model.Def_V_lineCC_return_bigM = Constraint(model.o,model.j,rule=Def_V_lineCC_return_rule_bigM)
...
model.Ex_M_prod_max = Constraint(model.i,model.k,rule=Ex_M_prod_max_rule)
...
model.Ex_M_prod_min = Constraint(model.i,model.k,rule=Ex_M_prod_min_rule)
...
model.Ex_M_linePC_max = Constraint(model.i,model.j,rule=Ex_M_linePC_max_rule)
...
model.Ex_M_lineCP_max = Constraint(model.j,model.i,rule=Ex_M_lineCP_max_rule)
...
model.Ex_M_lineCC_parallel_max = Constraint(model.j,model.o,rule=Ex_M_lineCC_parallel_max_rule)
...
model.Ex_M_lineCC_return_max = Constraint(model.o,model.j,rule=Ex_M_lineCC_return_max_rule)
...
model.bilanA_debit_supply = Constraint(model.j,rule=bilanA_debit_supply_rule)
...
model.bilanB_debit_hx_in = Constraint(model.j,rule=bilanB_debit_hx_in_rule)
...
model.bilanD_debit_hx_out = Constraint(model.j,rule=bilanD_debit_hx_out_rule)
...
model.bilanE_debit_return = Constraint(model.j,rule=bilanE_debit_return_rule)
...
model.bilanF_debit_prod_tot_in = Constraint(model.i,rule=bilanF_debit_prod_tot_in_rule)
...
model.bilanI_debit_prod_tot_out = Constraint(model.i,rule=bilanI_debit_prod_tot_out_rule)
...
model.bilanGH_debit_prod_out = Constraint(model.i,rule=bilanGH_debit_prod_out_rule)
...
model.bilanA_H_supply = Constraint(model.j,rule=bilanA_H_supply_rule)
...
model.bilanB_T_hx_in_bigM = Constraint(model.j,model.o,rule=bilanB_T_hx_in_rule_bigM)
...
model.bilanB2_T_hx_in = Constraint(model.j,rule=bilanB2_T_hx_in_rule)
...
model.bilanD_H_hx_out = Constraint(model.j,rule=bilanD_H_hx_out_rule)
...
model.bilanE_T_return_bigM = Constraint(model.i,model.j,rule=bilanE_T_return_rule_bigM)
...
model.bilanE2_T_return_bigM = Constraint(model.o,model.j,rule=bilanE2_T_return_rule_bigM)
...
model.bilanF_H_prod_tot_in = Constraint(model.i,rule=bilanF_H_prod_tot_in_rule)
...
model.bilanG_T_prod_in_bigM = Constraint(model.i,model.k,rule=bilanG_T_prod_in_rule_bigM)
...
model.bilanH_H_prod_out = Constraint(model.i,rule=bilanH_H_prod_out_rule)
...
model.bilanI_T_prod_tot_out_bigM = Constraint(model.i,model.j,rule=bilanI_T_prod_tot_out_rule_bigM)
...
model.bilan_H_inst_bigM1 = Constraint(model.i,model.k,rule=bilan_H_inst_rule_bigM1)

def bilan_H_inst_rule_bigM2(model,i,k):
    """..... Inéquation 2 du bigM"""
    return model.H_inst[i,k]*model.Eff[k] >= model.M_prod[i,k] * model.Cp * (model.T_prod_out[i,k] - model.T_prod_in[i,k]) - model.H_inst_bigM*(1-model.Y_P[i,k])
model.bilan_H_inst_bigM2 = Constraint(model.i,model.k,rule=bilan_H_inst_rule_bigM2)
...
model.bilan_chaleur_HX = Constraint(model.j,rule=bilan_chaleur_HX_rule)
...
model.bilan_DT1 = Constraint(model.j,rule=bilan_DT1_rule)
...
model.bilan_DT2 = Constraint(model.j,rule=bilan_DT2_rule)
...
model.bilan_DT1_pinch = Constraint(model.j,rule=bilan_DT1_pinch_rule)
...
model.bilan_DT2_pinch = Constraint(model.j,rule=bilan_DT2_pinch_rule)
...
model.diffTemplog = Constraint(model.j, rule=diffTemplog_rule)
...
model.bilan_chaleur_HX_DTLM = Constraint(model.j,rule=bilan_chaleur_HX_DTLM_rule)
...
model.loss_linePC = Constraint(model.i, model.j,rule=loss_linePC_rule)
...
model.loss_lineCP = Constraint(model.j, model.i,rule=loss_lineCP_rule)
...
model.loss_lineCC_parallel = Constraint(model.j, model.o,rule=loss_lineCC_parallel_rule)
...
model.loss_lineCC_return = Constraint(model.o, model.j,rule=loss_lineCC_return_rule)
...
model.contrainte_appro = Constraint(model.j, rule=contrainte_appro_rule)
...
model.cout_pompage = Constraint(rule=cout_pompage_rule)
...
model.cout_heat = Constraint(rule=cout_heat_rule)
...
model.cout_puissance = Constraint(rule=cout_puissance_rule)
...
model.cout_echangeur = Constraint(rule=cout_echangeur_rule)
...
model.cout_canalisation_tuyau = Constraint(rule=cout_canalisation_tuyau_rule)
...
model.cout_canalisation_tranchee = Constraint(rule=cout_canalisation_tranchee_rule)
...
model.cout_canalisation_tot = Constraint(rule=cout_canalisation_tot_rule)
...
model.Ex_L_tot = Constraint(rule=Ex_L_tot_rule)
...
#-----------------------------------------------------------------------------------------#
    ...
    def pyomo_postprocess(options=None, instance=None, results=None):
        ...
        with open('./Solution.txt', 'w') as f:
            f.write ('{} {}\n'.format("///Objective///\n", round(value(instance.objective),2)))
            f.write('///Variables///\n')
